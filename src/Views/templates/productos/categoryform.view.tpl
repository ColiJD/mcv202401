<h2>{{modeDesc}}</h2>
<section>
  <form action="index.php?page=Product_categoryForm&mode={{mode}}&category_id=" {{category_id}}"" method="post">
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    btnCancelar.addEventListener('click', function (e) {
      e.preventDefault();
      e.stopPropagation();
      window.location.href = 'index.php?page=Product_CategoriesList';
    });
  });
</script>